...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GNRO features */
        {"genero", "masternode", &masternode, true, true, false},
        {"genero", "masternodelist", &masternodelist, true, true, false},
        {"genero", "mnbudget", &mnbudget, true, true, false},
        {"genero", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"genero", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"genero", "mnsync", &mnsync, true, true, false},
        {"genero", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"genero", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use generod, or the -server option to genero-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Genero Alert\" admin@foo.com\n"),
...
{
    return "> genero-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:13179/\n";
}
