...
/** Utility functions used by the GNRO Qt UI.
 */
namespace GUIUtil
{
...
// Render GNRO addresses in monospace font
...
// Parse "genero:" URI into recipient object, return true on successful parsing
