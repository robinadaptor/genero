// Copyright (c) 2012-2014 Bitcoin Core developers
// Copyright (c) 2014-2015 Dash and PIVX Core Developers
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:13178", "127.0.0.1", 13178));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:13178", "127.0.0.1", 13178));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:13178", "::ffff:127.0.0.1", 13178));
    BOOST_CHECK(TestSplitHost("[::]:13178", "::", 13178));
    BOOST_CHECK(TestSplitHost("::13178", "::13178", -1));
    BOOST_CHECK(TestSplitHost(":13178", "", 13178));
    BOOST_CHECK(TestSplitHost("[]:13178", "", 13178));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:13178", "127.0.0.1:13178"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:13178", "[::]:13178"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
