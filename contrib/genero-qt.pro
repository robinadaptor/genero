...
RESOURCES += src/qt/genero.qrc src/qt/genero_locale.qrc

TRANSLATIONS += src/qt/locale/genero_bg.ts \
                src/qt/locale/genero_de.ts \
                src/qt/locale/genero_en.ts \
                src/qt/locale/genero_es.ts \
                src/qt/locale/genero_fi.ts \
                src/qt/locale/genero_fr.ts \
                src/qt/locale/genero_it.ts \
                src/qt/locale/genero_ja.ts \
                src/qt/locale/genero_pl.ts \
                src/qt/locale/genero_pt.ts \
                src/qt/locale/genero_ru.ts \
                src/qt/locale/genero_sk.ts \
                src/qt/locale/genero_sv.ts \
                src/qt/locale/genero_vi.ts \
                src/qt/locale/genero_zh_CN.ts \
                src/qt/locale/genero_zh_TW.ts
